...
pretrained_vectors		pretrained word vectors (.vec file) for supervised learning []
    ...
    classifier=fasttext.supervised(saveDataFile, output='./mod/xjpnews_classifier_model3',dim=200,min_count=1,ws=10,epoch=150,neg=5,word_ngrams=2,bucket=1)#, label_prefix='__lable__'  dim=200,min_count=1,ws=10,epoch=150,neg=4
