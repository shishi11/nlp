...
ddp = DDParser()
print(ddp.parse("在华盛顿期间，习主席还先后会见了前来参加本届核安全峰会的丹麦首相拉斯穆森、韩国总统朴槿惠和阿根廷总统马克里，并出席了伊核问题六国机制领导人会议。"))
json=[{'word': ['在', '华盛顿', '期间', '，', '习主席', '还', '先后', '会见', '了', '前来', '参加', '本届', '核安全', '峰会', '的', '丹麦', '首相', '拉斯穆森', '、', '韩国', '总统', '朴槿惠', '和', '阿根廷', '总统', '马克里', '，', '并', '出席', '了', '伊', '核', '问题', '六国', '机制', '领导人', '会议', '。'],
'head': [3, 3, 8, 3, 8, 8, 8, 0, 8, 17, 10, 14, 14, 11, 10, 17, 18, 8, 18, 21, 22, 18, 26, 25, 26, 18, 26, 29, 8, 29, 32, 33, 29, 35, 36, 37, 29, 8],
'deprel': ['MT', 'ATT', 'ADV', 'MT', 'SBV', 'ADV', 'ADV', 'HED', 'MT', 'ATT', 'VV', 'ATT', 'ATT', 'VOB', 'MT', 'ATT', 'ATT', 'VOB', 'MT', 'ATT', 'ATT', 'COO', 'MT', 'ATT', 'ATT', 'COO', 'MT', 'ADV', 'IC', 'MT', 'ATT', 'ATT', 'VOB', 'ATT', 'ATT', 'ATT', 'VOB', 'MT']}]
