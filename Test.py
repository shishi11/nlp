...
res = tn.parse(target=u'8日')
print(res)

res = tn.parse(target=u'去年年底')
print(res)

content = '25年后，在冷战时期的古巴导弹危机的阴影下，曾参与“暗杀希特勒计划”的前德国国防军军官埃瓦尔德·海因里希·冯·克莱斯特选择慕尼黑创办了安全会议，旨在增进有关各方对核事务的专业认识，促进跨大西洋联盟的交流。'
res=tn.parse(content)
print(res)
#
#
#
